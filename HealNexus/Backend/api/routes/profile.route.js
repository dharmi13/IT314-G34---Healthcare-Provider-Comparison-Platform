...
router.post('/create-patient', upload.single('image'), createPatientProfile);
...
router.post('/create-doctor', upload.single('image'), createDoctorProfile);
router.put('/update-doctor/:id', verifyToken, updateDoctorProfile);
router.get('/get-doctor/:id', verifyToken, getDoctorProfile);

router.post('/create-lab-technician', upload.single('image'), createLabTechnicianProfile);
...
router.post('/create-pharmacist', upload.single('image'), createPharmacistProfile);
