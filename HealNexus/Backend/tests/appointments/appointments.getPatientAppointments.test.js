...
describe('Get Appointment Details Route Tests', () => {
  beforeAll(async () => {
  ...
  describe('GET /appointment/get-details', () => {
    it('should successfully retrieve appointment details with doctor and patient info', async () => {
