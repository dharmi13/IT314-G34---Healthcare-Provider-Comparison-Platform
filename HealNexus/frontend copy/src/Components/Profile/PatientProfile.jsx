...
export default function PatientProfile() {
    return (
        <form className="bg-green-100 p-4 rounded-lg shadow-md">
            ...
            <input className="w-full p-2 mb-3 border border-gray-300 rounded-lg" placeholder="Age" />
            <input className="w-full p-2 mb-3 border border-gray-300 rounded-lg" placeholder="Gender" />
            <input className="w-full p-2 mb-3 border border-gray-300 rounded-lg" placeholder="Contact Number" />
            <input className="w-full p-2 mb-3 border border-gray-300 rounded-lg" placeholder="Emergency Contact" />
            <input className="w-full p-2 mb-3 border border-gray-300 rounded-lg" placeholder="Medical History" />
