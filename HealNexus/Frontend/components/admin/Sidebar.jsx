...
import { AdminContext } from '../../pages/admin/context/AdminContext.jsx'
import { NavLink } from 'react-router-dom'
import { home_icon,appointment_icon, add_icon, people_icon } from '../../assets/assets_copy.js'
import { DoctorContext } from '../../pages/admin/context/DoctorContext.jsx';
    ...
    <div className='min-h-screen bg-white border-r'>
       {
            <ul className='text-[#515151] mt-5 '>
              <NavLink to={'/admin_dash'}  className={({ isActive }) => `flex items-center gap-3 px-9 py-3.5 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`} >
