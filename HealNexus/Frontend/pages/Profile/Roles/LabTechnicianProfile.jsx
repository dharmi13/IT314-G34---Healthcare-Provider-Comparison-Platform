...
export default function LabTechnicianProfile() {
    return (
        <form className="bg-pink-100 p-4 rounded-lg shadow-md">
            ...
            <input className="w-full p-2 mb-3 border border-gray-300 rounded-lg" placeholder="Associated Lab" />
            <input className="w-full p-2 mb-3 border border-gray-300 rounded-lg" placeholder="Specialization" />
            <input className="w-full p-2 mb-3 border border-gray-300 rounded-lg" placeholder="Years of Experience" />
            <input className="w-full p-2 mb-3 border border-gray-300 rounded-lg" placeholder="Certifications" />
